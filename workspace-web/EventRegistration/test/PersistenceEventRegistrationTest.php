<?php
//require_once '.../EventRegistration/persistence/PersistenceEventRegistration.php';
//require_once '.../EventRegistration/model/RegistrationManager.php';
//require_once '.../EventRegistration/model/Participant.php';
